package com.task.assignment.util;
...
public class AspectLogger {
     ...
     */
    @Before("execution(* *(..)) && @annotation(com.task.assignment.annotations.LogMethod)")
     ...
     */
    @AfterReturning(
            pointcut = "execution(* *(..)) && @annotation(com.task.assignment.annotations.LogMethod)",
            returning = "result")
